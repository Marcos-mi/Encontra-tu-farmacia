...
const expresiones = {
	...
	consulta: /^[a-zA-Z0-9\_\-]{4,16}$/ // Letras, numeros, guion y guion_bajo 
}
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.nombre && campos.apellido && campos.correo && campos.telefono && campos.consulta && terminos.checked && novedades.checked){
		formulario.reset();
